...
/**
 * @className: com.pivotal.cloud.boot.utils.OkHttpClientUtil
 * @projectName: 封装PivotalCloud项目-OkHttpClientUtil类
 * @module: PivotalCloud项目-OkHttpClientUtil类，主要位于OkHttpClientUtil模块的业务场景
 * @content: OkHttpClientUtil类，主要用于完成OkHttpClientUtil的封装和定义.
 * @author: Powered by Marklin
 * @datetime: 2023-07-26 20:42
 * @version: 1.0.0
